      ...
      <div className="flex flex-wrap items-stretch justify-end divide-x divide-[#E4E3E0]/20">
        ...
        {exportSheets && (
          <button
            ...
            disabled={busy}
            className="px-4 py-2 text-[#E4E3E0] text-[10px] font-bold uppercase flex items-center gap-1.5 hover:bg-white/10 transition-colors disabled:opacity-50 whitespace-nowrap"
